    ...
    $('#form2').on('submit', function(e){
        ...
        $.ajax({
            ...
            success:function(json){
                ...
                if(json.success == '100'){
                    $('#errSenha').html('<div class="alert alert-success" role="alert">Cadastro efetuado com sucesso! <a href="http://easypassword.ml/login"><b>Faça Login</b></a></div>');
