                ...
                <div class="form-panel">
                    <h2 class="mb"><i class="fa fa-angle-right"></i> Cadastro de categorias &nbsp
                        ...
                        <div id="tooltip" role="tooltip">
                            ...
                            A vinculação pode ser feita no momento de salvar a senha ou no menu Visualizar senhas <br>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if($categoria['usuario_id'] == null): ?>
                                    <th></th>
                                <?php else: ?>
                                    <th scope="row">
                                        <a href="<?php echo BASE_URI . '/excluir-categoria/' . $categoria['categoria_id']; ?>">Excluir</a>
                                        &nbsp | &nbsp
